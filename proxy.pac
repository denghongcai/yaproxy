var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/^mail\.dhc\.house$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)techtablets\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gravatar\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fonts\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)directspace\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)hertzen\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)golang\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)tf3dm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)disqus\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mongodb\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)travis-ci\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)disquscdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)datatables\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)olark\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)stripe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)rackcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)kafeitu\.me$/.test(host)) return "+proxy";
        if (/(?:^|\.)google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)langpop\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)0o\.no$/.test(host)) return "+proxy";
        if (/(?:^|\.)nodejs\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)emscripten\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudflare\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)babeljs\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloud-cdn-digitalocean-com\.global\.ssl\.fastly\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)ecmsglobal\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)imgur\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mockable\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)pagekit\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)travis-ci-org\.global\.ssl\.fastly\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)edgefonts\.net$/.test(host)) return "+proxy";
